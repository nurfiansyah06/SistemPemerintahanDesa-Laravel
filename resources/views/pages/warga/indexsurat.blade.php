        ...
        <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a href="{{ route('suratwarga.show', $surat->id) }}">
                        <button class="btn btn-primary"><i class="fas fa-eye fa-sm text-white-50"></i></button>
                    </a>
                    <form action="{{ route('suratwarga.destroy',$surat->id) }}" method="post" class="d-inline">
                      @csrf
                      @method('delete')
      ...
      <div class="modal-body">
        <form action="{{ route('suratwarga.store') }}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="alamatrumah" id="">
          </div>
            <div class="form-group">
